...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ViewInteraction textView = onView(allOf(withId(R.id.section_label), withText("Page: 1")));
        ...
        ViewInteraction textView2 = onView(allOf(withId(R.id.section_label), withText("Page: 2")));
        ...
        ViewInteraction textView3 = onView(allOf(withId(R.id.section_label), withText("Page: 1")));
